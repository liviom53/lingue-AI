...
export function Scene1() {
  ...
  return (
    ...
    >
      {/* Badge */}
      <motion.div
        className="px-6 py-2 rounded-full border-2 border-[#0ea5e9]/50 bg-[#0ea5e9]/10 backdrop-blur mb-10 flex items-center gap-3"
      ...
      {/* Title */}
      <motion.h1
        className="text-[11vw] font-black tracking-tight leading-none text-white text-center"
      ...
      >
        <p className="text-[2.8vw] font-bold text-white/85" style={{ fontFamily:'Inter, sans-serif' }}>
          Ogni uscita. Ogni cattura. Ogni previsione.
        </p>
        <div className="bg-[#f59e0b] text-[#051525] px-8 py-3 rounded-xl rotate-[-2deg] shadow-xl mt-2">
          <span className="text-[2.2vw] font-black uppercase" style={{ fontFamily:'Inter, sans-serif' }}>
